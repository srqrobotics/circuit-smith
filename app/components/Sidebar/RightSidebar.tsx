      ...
      <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-2">
        ...
        {isLoading ? (
          ...
          <div className="text-sm flex items-center mt-0.5 min-h-[1.25rem]">
            <span className="text-gray-500 dark:text-gray-400 truncate">{getFilePath()}</span>
            {getFilePath() && <span className="mx-1 text-gray-500 dark:text-gray-400">/</span>}
            <span className="text-gray-700 dark:text-gray-300 truncate font-medium">{getFileName()}</span>
          </div>
        )}
      </div>
